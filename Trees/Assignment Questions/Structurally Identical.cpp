...
// Structurally Identical: Two trees are structurally identical if they are made of nodes with the same values arranged in the same way.

// Input format :
// The first line of input contains data of the nodes of the first tree in level order form. The order is: data for root node, number of children to root node, data of each of child nodes and so on and so forth for each node. The data of the nodes of the tree is separated by space. The following line of input contains data of the nodes of the second tree in level order form. The order is: data for root node, number of children to root node, data of each of child nodes and so on and so forth for each node. The data of the nodes of the tree is separated by space.
...
bool areIdentical(TreeNode<int> *root1, TreeNode<int> *root2)
{
    ...
    {
        for (int i = 0; i < (int)root1->children.size(); i++)
        {
