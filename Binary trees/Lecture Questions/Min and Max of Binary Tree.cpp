...
// For a given Binary Tree of integers, find and return the minimum and the maximum data values. Return the output as an object of Pair class, which is already created.
...
pair<int, int> getMinAndMax(BinaryTreeNode<int> *root)
{
    ...
    int minele = min(root->data, min(rightchild.first, leftchild.first));
    int maxele = max(root->data, max(rightchild.second, leftchild.second));
