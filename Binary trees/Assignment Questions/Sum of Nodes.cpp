...
// For a given a Binary Tree of type integer, find and return the sum of all the nodes data.
/*
Example:
        10
      /   \
...
When we sum up all the nodes data, we get 150. (i.e. 10+20+30+40+50)
*/
